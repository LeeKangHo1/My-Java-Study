...
- db 그림파일을 이클립스로 가져오기
	- ![](image/이클립스에서%20db%20그림파일%20가져오기.jpg)
...
- 인코딩
	- ![](image/base64%20인코딩%20디코딩.jpg)
		- byte\\\[] -> 이진 정보 모음을 담는 배열
		- Encoder 객체와 Decoder 객체 활용
		- ![](image/base64%20DAO%20insert.jpg)
...
- administration에서 users and privileges에서 계정을 만든다.
	- ![](image/users%20and%20privileges.jpg)
...
- 최초 접속화면(홈 버튼 누르면 나오는 화면)
	...
	- ![](image/setup%20new%20connection.jpg)
